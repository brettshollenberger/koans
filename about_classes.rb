...
class AboutClasses < Neo::Koan
  ...
  def test_you_can_rip_the_value_out_using_instance_eval
    ...
    assert_equal "Jake", fido.instance_eval("@name")  # string version
    assert_equal "Jake", fido.instance_eval { @name } # block version
  end
